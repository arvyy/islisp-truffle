...
/**
 * Implements `mapcan` function.
 */
public abstract class ISLISPMapcan extends RootNode {

    @Child
    ISLISPErrorSignalerNode errorSignalerNode;

    ISLISPMapcan(TruffleLanguage<?> language) {
        super(language);
    ...
    public final Object execute(VirtualFrame frame) {
        ...
        try {
            ...
            //TODO
            throw new ISLISPError("mapcan fail", this);
        }
    }
    ...
    public static LispFunction makeLispFunction(TruffleLanguage<?> lang) {
        return new LispFunction(ISLISPMapcanNodeGen.create(lang).getCallTarget());
    }
