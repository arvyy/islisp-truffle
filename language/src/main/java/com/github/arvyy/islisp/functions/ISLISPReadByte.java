...
/**
 * Implements `read-byte` procedure.
 */
public abstract class ISLISPReadByte extends RootNode {
    ...
    ISLISPReadByte(TruffleLanguage<?> language) {
        super(language);
    ...
    public static LispFunction makeLispFunction(TruffleLanguage<?> lang) {
        return new LispFunction(ISLISPReadByteNodeGen.create(lang).getCallTarget());
    }
