...
/**
 * Implements `open-io-file` function.
 */
public abstract class ISLISPOpenIOFile extends RootNode {

    @Child
    ISLISPErrorSignalerNode errorSignalerNode;

    ISLISPOpenIOFile(TruffleLanguage<?> language) {
        super(language);
    ...
    public static LispFunction makeLispFunction(TruffleLanguage<?> lang) {
        return new LispFunction(ISLISPOpenIOFileNodeGen.create(lang).getCallTarget());
    }
