...
/**
 * Implements `mapcon` function.
 */
public abstract class ISLISPMapcon extends RootNode {

    @Child
    ISLISPErrorSignalerNode errorSignalerNode;

    ISLISPMapcon(TruffleLanguage<?> language) {
        super(language);
    ...
    public final Object execute(VirtualFrame frame) {
        ...
        try {
            ...
            //TODO
            throw new ISLISPError("mapcon fail", this);
        }
    }
    ...
    public static LispFunction makeLispFunction(TruffleLanguage<?> lang) {
        return new LispFunction(ISLISPMapconNodeGen.create(lang).getCallTarget());
    }
