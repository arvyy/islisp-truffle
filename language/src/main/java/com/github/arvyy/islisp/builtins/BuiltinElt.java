...
public abstract class BuiltinElt extends RootNode {

    protected BuiltinElt(TruffleLanguage<?> language) {
        super(language);
    }
    ...
    public static LispFunction makeLispFunction(TruffleLanguage<?> lang) {
        return new LispFunction(BuiltinEltNodeGen.create(lang).getCallTarget());
    }
