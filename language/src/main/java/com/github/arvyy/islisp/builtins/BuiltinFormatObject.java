...
public abstract class BuiltinFormatObject extends RootNode {

    protected BuiltinFormatObject(TruffleLanguage<?> language) {
        super(language);
    }
    ...
    public static LispFunction makeLispFunction(TruffleLanguage<?> lang) {
        return new LispFunction(BuiltinFormatObjectNodeGen.create(lang).getCallTarget());
    }
}
