...
public class BuiltinCreateVector extends RootNode {

    protected BuiltinCreateVector(TruffleLanguage<?> language) {
        super(language);
    }
    ...
    public static LispFunction makeLispFunction(TruffleLanguage<?> lang) {
        return new LispFunction(new BuiltinCreateVector(lang).getCallTarget());
    }
}
