...
public abstract class BuiltinCdr extends RootNode {

    protected BuiltinCdr(TruffleLanguage<?> language) {
        super(language);
    }
    ...
    public static LispFunction makeLispFunction(TruffleLanguage<?> lang) {
        return new LispFunction(BuiltinCdrNodeGen.create(lang).getCallTarget());
    }
