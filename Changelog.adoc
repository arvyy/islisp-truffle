...
* Refactor parsers and macro facilities to operate on syntax objects (that carry source location) instead of datums
* Bump GraalVM version to 25
* Optimize comparison functions (`>=`, ..., `char>=`, ...)
* Add missing functions `float`, `floatp`
* Add missing constants `*most-positive-float*`, `*most-negative-float*`
